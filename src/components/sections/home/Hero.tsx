...
const DEFAULT_HERO = {
  ...
  description: "Pair compelling copy with a high-impact visual. Perfect for SaaS, product launches, and creative studios.",
  features: [
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="relative">
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold" data-editable="statsValue1">{config.statsValue1}</span>
              </p>
            </div>
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold" data-editable="statsValue2">{config.statsValue2}</span>
              </p>
            </div>
          </div>
        </div>
